...
function App() {
  const [color, setColor] = useState("leavender")
  ...
  return (
      ...
      style={{backgroundColor: color}}>
        ...
        <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
          ...
          <div className="flex flex-wrap justify-center gap-3 shadow-lg  px-3 py-2 rounded-3xl bg-yellow-200">

            <button 
            onClick={ () => setColor("red")}
            className="outline-none px-4 py-1 rounded-full text-white shadow-lg border border-black" 
